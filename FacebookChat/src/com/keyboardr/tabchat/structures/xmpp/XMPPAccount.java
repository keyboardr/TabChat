package com.keyboardr.tabchat.structures.xmpp;
...
public class XMPPAccount extends CombAccount implements ChatManagerListener {
	...
	public XMPPAccount(JSONObject jObject) throws JSONException {
		mUsername = jObject.getString("username");
		mPassword = jObject.getString("password");
		mServer = jObject.getString("server");
		mPort = jObject.getInt("port");
	}
	...
	public JSONObject toJson() throws JSONException {
		JSONObject jObject = super.toJson();
		jObject.put("username", mUsername);
		jObject.put("password", mPassword);
		jObject.put("server", mServer);
		jObject.put("port", mPort);
		return jObject;
	}
